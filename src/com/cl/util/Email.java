...
public class Email {
    ...
    public String setContents(HashMap<String, Object> hMap){
		...
		contents += "</tr>";
		contents += "<tr>";
		contents += "<td style='color: rgb(77, 77, 77); line-height: 14px; font-size: 12px;><img src='http://agni121.cafe24.com/public/img/common/t_logo.png'></td>";
		contents += "</tr>";
		contents += "<tr>";
		contents += "<td height='20' style='color: rgb(77, 77, 77); line-height: 14px; font-size: 12px;></td>";
		contents += "</tr>";
		contents += "<tr>";
		contents += "<td height='2' style='color: rgb(77, 77, 77); line-height: 14px; font-size: 12px;' bgcolor='#000000'></td>";
		contents += "</tr>";
		contents += "<tr>";
		contents += "<td height='20' style='color: rgb(77, 77, 77); line-height: 14px; font-size: 12px;></td>";
		contents += "</tr>";
		contents += "<tr>";
		contents += "<td class='texts' style='color: rgb(97, 106, 116); line-height: 22px; padding-left: 10px; font-family: 돋움, Dotum; font-size: 12px;><b>임시비밀번호 :</b>"+hMap.get("tmpPass")+"</td>";
		contents += "</tr>";
		contents += "<tr>";
		contents += "<td height='20' style='color: rgb(77, 77, 77); line-height: 14px; font-size: 12px;></td>";
		contents += "</tr>";
