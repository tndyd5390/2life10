...
<form action="#" name="menuFrm" method="post">
	<input type="hidden" name="menuNum"/>
			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<br/><br/>
				<strong class="blueTit">가족 또는 지인 누구에게나 가입자의 명의에 상관없이 이용가능합니다.</strong>
				<ul class="defaultGrayDotList mt-10">
				...
				<ul class="defaultGrayDotList mt-10">
					<li>만기완납 1년 후 회원 요청시 실납입금액의 전액을 환급해드리며, 60회차는 만기완납 5년 후 전액을 환급하여 드립니다. (2011년 1월 가입자부터 적용되며, 회원가입시 뒷면 약관에 명시하였습니다.)</li>
				</ul>
				<br/><br/>
