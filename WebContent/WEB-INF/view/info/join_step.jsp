				...
				<div class="tableBasicList">
					<table class="defaultTable">
						...
						<tbody>
							<tr>
								<td>임종전</td>
								<td class="alignL">1644-4491(고객센터)로 전화하셔서 행사장소,장례절차,사용상품 등 행사 전반에 대한 사전 상담을 받으시면 행사발생 시 당황하지 않고 장례를 치를 수 있습니다.</td>
							</tr>
							<tr>
								<td>임종일</td>
								<td class="alignL">임종확인 > 사망확인 후 즉시 전화로 행사접수(1644-4491) > 장례지도사 파견 > 제단장식, 상복제공, 도우미 파견 </td>
							</tr>
							<tr>
								<td>2일차</td>
								<td class="alignL">입관(장례지도사 2명 진행) > 도우미 파견</td>
							</tr>
							<tr>
								<td>3일차</td>
								<td class="alignL">미납금결제(납입도중 장례발생 시) > 발인 > 제공되는 장의차량으로 담당자와 함께 장지동행 (왕복)</td>
							</tr>
						</tbody>
					</table>
				</div>
