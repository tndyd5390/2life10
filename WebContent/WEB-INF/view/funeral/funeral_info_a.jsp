	...
	<input type="hidden" name="menuNum"/>
			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<ul class="defaultGrayDotList mt-10">
					...
					이 추도예배를 통해 돌아가신 분을 기억하며 추모하고 유족들간의 위로와 친교를 다지며 신앙을 더욱 돈독히 하는 계기로 삼는다면 영적으로나 도덕적으로 또는 사회 윤리적 차원까지도 부족함없이 많이 유익을 얻을 수 있을 것입니다.</li>
				</ul>
				<br/><br/>
				...
				<p class="txt">오늘은 하나님께서 일찍이 고 000성도님(어른, 선생님)을 하나님 나라로 불러가신 날이어서 유족들과 고인과 관계된 모든 이들이 함께 모여 예배를 드립니다. 용서의 하나님 아버지, 우리가 고인을 통한 아버지의 큰 뜻을 헤아릴 수 없어 그 뜻을 펴지 못한 우리의 부족함을 고백합니다.</p>
