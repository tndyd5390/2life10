	...
	<input type="hidden" name="menuNum"/>
			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<div class="defaultTab">
				    <strong class="select">
                        <button type="button">기독교장례 및 추도예매</button>
                    </strong>
					<ul>
						<li class="tab01 active"><a href="javascript:goMenu('../funeral/funeral_info_a.jsp', 'MN30300');">기독교장례 및 추도예매</a></li>
				...
				<header class="contInfoArea">
					...
					<div class="area">
						...
						운명을 하면 찬송과 기도로 고인의 영혼을 하나님께 맏기는 뜻의 예배를 드리며 목사님의 집례로 기도회를 갖고,
						기독교식 장례는 곡을 하지 않고, 제사음식을 차리지 않으며 배려(절)을 하지 않는다.<br/>
						또 조석에 전과 상식(上食)을 올리지 않는다. 영결식 전날 성도들은 염습 및 입관을 마치고 목사님의 집례로
						입관예배를 드린다.<br/>
						영결식은 영구를 교회에서 안치하거나 상가에서 간단하게 행하는 경우가 있으며, 분향대신 영전에 한화를 한다.</p>
					</div>
				</header>
				...
				<ul class="defaultGrayDotList mt-10">
					<li>기독교식 장례는 운명하는 사람의 영혼을 찬송과 기독속에서 하나님께 맏기는 것으로 목사님의 집례아래 진행된다.</li>
					<li>성도가 입종하면 담임목사에게 가장 먼저 연락을 하고 목사님이 오면 임종예배를 드리고 장례 일정 및 제반사항을 의논하며 분향을 하지 않고 헌화를 한다. 제사상차림과 곡은 하지 않고 검소하고 경건한 마음과 분위기 가운데 장례를 진행한다.</li>
				</ul>
				<br/><br/>
				<strong class="blueTit">입관예배</strong>
				<ul class="defaultGrayDotList mt-10">
					<li>입관은 유가족들이 다 모인 자리에서 하며 운명한 시신의 수시부터 목사님이 직접 주관하여 염습과 입관도 목사님의 집례하에 진행하며 입관후 입관예배를 드린다. 상복은 보통남자는 검정색 계통의 양복에 완장을 착용하고, 여자는 흰색이나 검정색 치마저고리로 입니다.</li>
				</ul>
				<br/><br/>
				<strong class="blueTit">발인예배</strong>
				<ul class="defaultGrayDotList mt-10">
					<li>출관식은 조문객들에게 하나님의 사랑과 공의를 인정하게 하고, 인간의 유한성과 무능함을 깨닫게 하는 좋은 기회가 됩니다.
					모든 예식이 그러하겠지만 출관식은 더욱 그러합니다. 그러므로 고인의 모든 흔적(모습)이 집을 떠나는 마지막 순간이기 때문에 예식이 있어서 분명한 목적이 있어야 합니다.
				...
				<ul class="defaultGrayDotList mt-10">
					...
					흙이 관 위에서 떨어지는 소리를 듣는 순간이 가장 슬프기 때문에 식순에 넣으면 취토를 할 때 유족들이 울음을 터뜨리기 때문에 식을 마치고 행하는 것이 좋습니다. 취토 전에 꽃이 있으면 먼저 헌화한 후에 할 수도 있으며, 그 순거가 주례자가 먼저한 후에 유족, 친척, 친지, 조문객 손으로 합니다. 취토할때의 기도문은 다음과 같습니다.</li>
				</ul>
				<br/><br/>
				...
				<ul class="defaultGrayDotList mt-10">
					...
					이 추도예배를 통해 돌아가신 분을 기억하며 추모하고 유족들간의 위로와 친교를 다지며 신앙을 더욱 돈돈히 하는 계기로 삼는다면 영적으로나 도덕적으로 또는 사회 윤리적 차원까지도 부족함없이 많이 유익을 얻을 수 있을 것입니다.</li>
				</ul>
				<br/><br/>
				<strong class="blueTit">준비</strong>
				<ul class="defaultGrayDotList mt-10">
					<li>고인의 사진을 상 위에 놓고 촛불과 꽃으로 장식합니다. (사진이 없는 경우에도 지방은 쓰지 않습니다. 단, 고인이 쓰시던 성경책을 상 위에 놓습니다.)</li>
					<li>가족들이 그 앞에 둘러앉고 집례자는 상옆에 앉거나 서서 인도합니다.</li>
				...
				<p class="txt">인간의 생사를 주관하시는 하나님 아버지, 슬품과 절망의 어두운 그늘속에서도 우리가 예수 그리스도의 은혜와 성령의 인도하심으로 믿음과 희망을 가지고 살게 하심을 감사드립니다.</p>
				<p class="txt">오늘은 하나님께서 일찍이 고 000성도님(어른, 선생님)을 하나님 나라로 불러가신 날이어서 유족들과 고인과 관계된 모든 이들이 함께 모여 예배를 드립니다. 용서의 하나님 아버지, 우리가 고인을 통한 아버지의 큰 뜻을 헤아릴 수 없어 그 뜻을 헤아릴 수 없어 그 뜻을 펴지 못한 우리의 부족함을 고백합니다.</p>
				...
				<p class="txt">예수님의 이름으로 기도하 옵니다. 아멘</p>
