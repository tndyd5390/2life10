			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<header class="contInfoArea">
					...
					<div class="area">
						...
						운명을 하면 찬송과 기도로 고인의 영혼을 하나님께 맡기는 뜻의 예배를 드리며 목사님의 집례로 기도회를 갖고,
				...
				<ul class="defaultGrayDotList mt-10">
					...
					<li>성도가 임종하면 담임목사님에게 가장 먼저 연락을 하고 목사님이 오면 임종예배를 드리고 장례 일정 및 제반사항을 의논하며 분향을 하지 않고 헌화를 한다. 제사상차림과 곡은 하지 않고 검소하고 경건한 마음과 분위기 가운데 장례를 진행한다.</li>
				</ul>
				<br/><br/>
				<strong class="blueTit">입관예배</strong>
				<ul class="defaultGrayDotList mt-10">
					<li>입관은 유가족들이 다 모인 자리에서 하며 운명한 시신의 수시부터 목사님이 직접 주관하여 염습과 입관도 목사님의 집례 하에 진행하며 입관 후 입관예배를 드린다. 상복은 보통 남자는 검은색 계통의 양복에 완장을 착용하고, 여자는 흰색이나 검은색 치마저고리로 입습니다.</li>
				</ul>
				<br/><br/>
