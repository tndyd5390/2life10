...
<form action="#" name="menuFrm" method="post">
	<input type="hidden" name="menuNum"/>
			...
			<div class="moLnbWrap">
				<nav class="flexContainer">
					...
					<div class="flexItem4"> <!-- .select 버튼 클릭시 다중클래스 on 추가 -->
						...
						<ul>
							<li id="MO80100"><a href="javascript:goMenu('../member/change_mem.jsp', 'MO80100');">회원정보수정</a></li>
						</ul>
					</div>
			...
			<div class="pcLnbWrap">
				<nav>
					<ul class="pcLnb">
						<li id="MN80100"><a href="javascript:goMenu('../member/change_mem.jsp', 'MN80100');">회원정보수정</a></li>
					</ul>
				</nav>
			</div> <!-- // pcLnbWrap -->
