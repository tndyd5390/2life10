	...
	<input type="hidden" name="menuNum"/>
			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<div class="businessIntro">
					...
					<p><strong>크루즈여행은 교통수단과 여행지가 결합된 형태로 국경통과의 번거로운 과정이 적고, 여행 시 버스 이동 등 교통수단으로 인한 피로감이 줄어듭니다. 또 크루즈 여행에서는 세계 각국의 음식이 무제한 제공되며 선상에서 뷔페식으로 다양하고 풍부한 메뉴를 즐길 수 있습니다. 최고급 시설을 갖춘 선박을 타고 아름다운 기항지 여행은 물론, 휴양과 묵상을 함께 할 수 있는 시간이 충분합니다. 지중해 연안의 아름다운 해협을 접해볼 수 있는 특별한 일정을 준비하였으며, 기본일정 외 각 기항지마다 크리스찬상조만의 성지순례장소를 선택하여 단독으로 일정이 진행됩니다.</strong></p>
				</div>
				<br/><br/>

				<strong class="blueTit">최고급 크루즈여행으로 가능한 성지순례</strong>
				<ul class="defaultGrayDotList mt-10">
					<li>믿음의 선진들이 걸었던 발자취를 따라 여행하며 그 신앙을 본받고 그 땅에 복음을 되새겨보는 뜻 깊은 시간입니다.</li>
				</ul>
				<br/><br/>
				<div class="businessUnit">
					<li class="unitTit">
