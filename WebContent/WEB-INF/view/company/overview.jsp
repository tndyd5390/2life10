...
<form action="#" name="menuFrm" method="post">
	<input type="hidden" name="menuNum"/>
			...
			<div id="info" class="contents"> <!-- 페이지별 ID -->
				...
				<div class="ceo01">
					<p><strong class="pointColor">하나님사랑과 이웃사랑을 실천하는<br/>크리스찬상조를 방문해 주셔서 감사합니다.</strong></p>

					<p>크리스찬상조는 기존의 가정의례 서비스를 넘어 라이프사이클 전반을 서비스하는 고품격의 종합 이벤트 회사입니다.</p>

					<p>여러 소비자의 필요를 충족시키기 위해 다양한 삼품을 준비하여, 갑작스러운 큰일이나 장기적인 계획을 가지고 준비해야 하는 일을 최고의 전문가들이 저렴하고 편리하게 최상의 서비스를 제공해드리는 회사입니다.</p>
					
					<p>항상 고객들의 작은 목소리에도 귀 기울이고 고객을 잘 이해하며 고객들이 가장 선호하는 기업이 되기 위해 열심히 노력하겠습니다.</p>

					<p>감사합니다.<br/><br/></p>

					<p><strong class="pointColor">상조는 '서로돕는다' 라는 의미로서,</strong><br/>미래에 필요한 용역서비스나 물품을 현시점에서 적은 할부금 형식으로 구매하는 방식으로서, 상조회원들이 회비를 납부하여 대량구매, 원가절감 효과로 10년 후 또는 20년 후에라도 가입금액 그대로 혜택을 받을 수 있는 물가보상시스템입니다.<br/><br/></p>
