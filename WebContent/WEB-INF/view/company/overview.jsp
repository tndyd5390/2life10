	...
	<input type="hidden" name="menuNum"/>
			...
			<div id="info" class="contents"> <!-- 페이지별 ID -->
				...
				<div class="ceo01">
					...
					<p><strong class="pointColor">상조는 '서로돕는다' 라는 의미로서,</strong><br/>미래에 필요한 용역서비스나 물품을 현시점에서 작은 할부금 형식으로 구매하는 방식으로서, 상조회원들이 회비를 납부하여 대량구매, 원가절감 효과로 10년 후 또는 20년 후에라도 가입금액 그대로 혜택을 받을 수 있는 물가보상시스템입니다.<br/><br/></p>
