...
<%
	CatalogueDTO cDTO = (CatalogueDTO) request.getAttribute("cDTO");
					...
					<table summary="">
						...
						<tbody>
							<tr>
								<th scope="row">상품명</th>
								<td>
									<input type="text" name="name" class="inputType1" value="<%=CmmUtil.nvl(cDTO.getCatalogueName())%>">
								</td>
							</tr>
							<tr>
								<th scope="row">내용</th>
								<td>
									<input type="text" name="contents" class="inputType1" value="<%=TextUtil.exchangeEscapeNvl(cDTO.getCatalogueContents())%>">
								</td>
							</tr>
							<tr>
								<th scope="row">시작일</th>
								<td>
									<input type="date" name="start" id="start" value="<%=CmmUtil.nvl(cDTO.getCatalogueStart())%>">
								</td>
							</tr>
							<tr>
								<th scope="row">종료일</th>
								<td>
									<input type="date" name="end" id="end" value="<%=CmmUtil.nvl(cDTO.getCatalogueEnd())%>">
								</td>
							</tr>
							<tr>
								<th scope="row">업로드</th>
