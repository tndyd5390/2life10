							...
							<tr>
								...
								<td>
									<select id="tel1" name="tel1" title="" class="inputType3">
										...
										<option value="051" <%=CmmUtil.select("051", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>051</option>
										<option value="053" <%=CmmUtil.select("053", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>053</option>
										<option value="032" <%=CmmUtil.select("032", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>032</option>
										<option value="062" <%=CmmUtil.select("062", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>062</option>
										<option value="042" <%=CmmUtil.select("042", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>042</option>
										<option value="052" <%=CmmUtil.select("052", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>052</option>
										<option value="044" <%=CmmUtil.select("044", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>044</option>
										<option value="031" <%=CmmUtil.select("031", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>031</option>
										<option value="033" <%=CmmUtil.select("033", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>033</option>
										<option value="043" <%=CmmUtil.select("043", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>043</option>
										<option value="041" <%=CmmUtil.select("041", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>041</option>
										<option value="063" <%=CmmUtil.select("063", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>063</option>
										<option value="061" <%=CmmUtil.select("061", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>061</option>
										<option value="054" <%=CmmUtil.select("054", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>054</option>
										<option value="055" <%=CmmUtil.select("055", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>055</option>
										<option value="064" <%=CmmUtil.select("064", AES256Util.strDecode(CmmUtil.nvl(mDTO.getMemberHomeNo())).split("-")[0]) %>>064</option>
									</select>
									-
								...
								<td>
									...
									-
									<input type="text" name="tel2" id="tel2" title="이름" class="inputType2" style="" maxlength="4">
									-
									<input type="text" name="tel3" id="tel3" title="이름" class="inputType2" style="" maxlength="4">
								</td>
								<%} %>
							</tr>
							<tr>
