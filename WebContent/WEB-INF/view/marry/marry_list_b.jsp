	...
	<input type="hidden" name="menuNum"/>
			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<div class="defaultTab">
				    <strong class="select">
                        <button type="button">웨딩360</button>
                    </strong>
					<ul>
						<li class="tab04"><a href="javascript:goMenu('/marry/marryList_d.do', 'MN40200');">프라임(350)상품</a></li>
						<li class="tab01"><a href="javascript:goMenu('/marry/marryList_a.do', 'MN40200');">웨딩240</a></li>
						<li class="tab02 active"><a href="javascript:goMenu('/marry/marryList_b.do', 'MN40200');">웨딩360</a></li>
						<li class="tab03"><a href="javascript:goMenu('/marry/marryList_c.do', 'MN40200');">웨딩480</a></li>
					</ul>
				</div>
				
				<header class="contInfoArea">
					<p class="img"><img src="/public/img/conts/img_pro_b_360.png" alt="웨딩360 안내이미지" /></p>
					<div class="area">
						<h3 class="contTit"><span>웨딩360</span></h3>
						<p class="subTxt">월 30,000원 X 120회 (3,600,000원)</p>
				...
				<div class="tableBasicList">
					<table class="defaultTable">
						...
						<tbody>
							...
							<tr>
								<td colspan="2" data-photo="201">비디오</td>
				...
				<article>
					<section>
						<ul class="nonumList">
							<li>주례, 폐백음식, 청접장, 사진촬영 저작권료 및 예식 도우미 비용은 별도입니다.</li>
							<li>납입도중 행사발생시 나머지 부금액을 행사 종료와 동시에 완납해야 합니다.
							<br/>(웨딩 진행 과정에서 본식 전 리허설 촬영 시 납부금액에 따라 중도금이 발행할 수 있습니다.)</li>
