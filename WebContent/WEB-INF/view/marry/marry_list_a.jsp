	...
	<input type="hidden" name="menuNum"/>
			...
			<div id="pro_info" class="contents"> <!-- 페이지별 ID -->
				...
				<div class="defaultTab">
				    <strong class="select">
                        <button type="button">웨딩240</button>
                    </strong>
					<ul>
						<li class="tab04"><a href="javascript:goMenu('/marry/marryList_d.do', 'MN40200');">프라임(350)상품</a></li>
						<li class="tab01 active"><a href="javascript:goMenu('/marry/marryList_a.do', 'MN40200');">웨딩240</a></li>
				...
				<header class="contInfoArea">
					<p class="img"><img src="/public/img/conts/img_pro_b_240.png" alt="웨딩240 안내이미지" /></p>
					<div class="area">
						<h3 class="contTit"><span>웨딩240</span></h3>
						<p class="subTxt">월 24,000원 X 100회 (2,400,000원)</p>
